...
target "angie-alpine-metadata" {
  ...
  tags = [
    "docker.io/${REPOSITORY}:1.11.2",
    "ghcr.io/${REPOSITORY}:1.11.2",
    "docker.io/${REPOSITORY}:1.11.2-alpine",
    "ghcr.io/${REPOSITORY}:1.11.2-alpine"
  ]
}
...
target "angie-debian-metadata" {
  ...
  tags = [
    "docker.io/${REPOSITORY}:1.11.2-debian",
    "ghcr.io/${REPOSITORY}:1.11.2-debian"
  ]
}
...
target "angie-debian-minimal-metadata" {
  ...
  tags = [
    "docker.io/${REPOSITORY}:1.11.2-debian-minimal",
    "ghcr.io/${REPOSITORY}:1.11.2-debian-minimal"
  ]
}
...
target "angie-minimal-metadata" {
  ...
  tags = [
    "docker.io/${REPOSITORY}:1.11.2-minimal",
    "ghcr.io/${REPOSITORY}:1.11.2-minimal"
  ]
}
...
target "angie-ubuntu-metadata" {
  ...
  tags = [
    "docker.io/${REPOSITORY}:1.11.2-ubuntu",
    "ghcr.io/${REPOSITORY}:1.11.2-ubuntu"
  ]
}
...
target "angie-ubuntu-minimal-metadata" {
  ...
  tags = [
    "docker.io/${REPOSITORY}:1.11.2-ubuntu-minimal",
    "ghcr.io/${REPOSITORY}:1.11.2-ubuntu-minimal"
  ]
}
