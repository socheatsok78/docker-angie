...
target "angie-debian-minimal-metadata" {
  ...
  tags = [
    "docker.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:1.11.0-debian-minimal",
    "ghcr.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:1.11.0-debian-minimal"
  ]
}
...
target "angie-ubuntu-minimal-metadata" {
  ...
  tags = [
    "docker.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:1.11.0-ubuntu-minimal",
    "ghcr.io/${replace(GITHUB_REPOSITORY, "docker-", "")}:1.11.0-ubuntu-minimal"
  ]
}
